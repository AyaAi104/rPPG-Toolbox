...
* [Daily Dataset]
    * Custom rPPG dataset with 10 subjects. Folder naming encodes experiment conditions: distance, lux, movement, angle, and device. Frame filenames are timestamps in milliseconds. Ground truth is a CSV with `PC_Timestamp_ms` and `Signal_Value` columns.
    -----------------
         Dataset_Root/
         |   |-- 1/
         ...
         |           |-- pulse_data.csv
         |       |-- vid_2m_30lux_Stationary_45deg_useiPhone/
         |           |-- ...
         |       |-- gt_2m_30lux_Stationary_45deg_useiPhone/
         |           |-- pulse_data.csv
         |       |...
         |   |-- 2/
         |       |-- vid_1m_30lux_Stationary_45deg_useiPhone/
