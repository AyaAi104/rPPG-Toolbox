...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        # My Dataset
        elif config.TRAIN.DATA.DATASET == "Aya":
            train_loader = data_loader.AyaLoader.AyaLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "Aya":
            valid_loader = data_loader.AyaLoader.AyaLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "Aya":
            test_loader = data_loader.AyaLoader.AyaLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS and iBVP.")
        ...
        if config.UNSUPERVISED.DATA.DATASET == "UBFC-rPPG":
            ...
            # update aya loader
        elif config.UNSUPERVISED.DATA.DATASET == "Aya":
            unsupervised_loader = data_loader.AyaLoader.AyaLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
